      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row md:justify-between">
        ...
        <div className="flex justify-around md:space-x-8 mb-6 md:mb-0">
          <div>
            ...
            <ul className="mt-2 space-y-2 text-gray-300">
              ...
              <li><Link href="/aboutme" className="hover:text-white">About Me</Link></li>
              <li><Link href="/classesandworkshop" className="hover:text-white">Classes</Link></li>
              <li><Link href="/eventandperformances" className="hover:text-white">Events</Link></li>
              <li><Link href="/admin/register" className="hover:text-white">Admin Signup</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-2 space-y-2 text-gray-300">
              ...
              <li><Link href="/contactme" className="hover:text-white">Contact</Link></li>
              <li><Link href="/faq" className="hover:text-white">FAQ</Link></li>
              <li><Link href="/merchandise" className="hover:text-white">Merchandise</Link></li>
              <li>
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-4 text-gray-400 text-sm">
            © {new Date().getFullYear()} PurasalsaMargiecolo.com. All rights reserved.
          </p>
          <p className="mt-4 text-gray-400 text-sm">
