      ...
      <section className="relative h-screen overflow-hidden">
         ...
         <div className="relative z-20 flex flex-col items-center justify-center h-full text-white bg-black bg-opacity-55 space-y-1">
            <Image
               ...
               height={300}
               priority
               className="mb-0" // Remove any additional margin
            />
            <h1 className="text-xl md:text-3xl lg:text-5xl font-bold -mt-4">
               Welcome to PurasalsaMargieColon.com
            </h1>
            <p className="mt-4 mb-4 text-xl">Dance. Connect. Learn.</p>
            <Link href="/classesandworkshop" className="bg-green-700 hover:bg-red-700 text-white py-2 px-8 rounded-full shadow-lg mt-4">Book Here</Link>
         </div>
